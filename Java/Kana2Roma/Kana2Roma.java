public class Kana2Roma {
	...
	for(int i=0;i<s.length();i++){
	    char c = s.charAt(i);
	    for(int j=0;j<keys.keypats.length;j++){
		Key[] keypat = keys.keypats[j];
	...
	/*
	System.out.println(keys.keypat11[0].str);
	System.out.println(keys.keypat11.length);
	System.out.println("ますい".length());
	System.out.println("ますい".charAt(2));
	*/
    }
}
